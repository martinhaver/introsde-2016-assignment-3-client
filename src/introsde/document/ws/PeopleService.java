 ...
 * 
 */
@WebServiceClient(name = "PeopleService", targetNamespace = "http://ws.document.introsde/", wsdlLocation = "https://introsde2016-assignment3.herokuapp.com/ws/people?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PEOPLESERVICE_QNAME = new QName("http://ws.document.introsde/", "PeopleService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://whispering-dawn-27156.herokuapp.com/ws/people?wsdl");
    ...
    public People getPeopleImplPort() {
        return super.getPort(new QName("http://ws.document.introsde/", "PeopleImplPort"), People.class);
    }
    ...
    public People getPeopleImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.document.introsde/", "PeopleImplPort"), People.class, features);
    }
